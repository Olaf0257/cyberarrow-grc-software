...
return [
    ...
    */
    ...
    // 'listener' => \App\Http\Controllers\Auth\mfa\EnforceTwoFactorAuth::class,
    'listener' => false,
    ...
    */
    ...
    'confirm' => [
        'timeout' => 10800, // 3 hours
        'view' => 'App\Http\Controllers\Auth\mfa\LoginConfirmMFACodeController@showConfirmForm',
        'action' => 'App\Http\Controllers\Auth\mfa\LoginConfirmMFACodeController@confirm'
    ],
