...
class Control extends Model
{
    ...
    protected $fillable = ['name', 'standard_id', 'slug', 'description', 'primary_id', 'sub_id', 'id_separator'];
    ...
    {
        return $this->belongsToMany(Project::class, 'compliance_project_control')->withPivot(['id', 'status', 'responsible', 'approver', 'deadline', 'frequency']);
    }
